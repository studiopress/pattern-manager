	...
	public function data_get_duplicate_pattern_ids() {
		return array(
			...
			array(
				...
				array(
					'filename'  => 'my-new-pattern-copied',
			...
			array(
				...
				array(
					'filename'  => 'my-new-pattern-copied-1',
			...
			array(
				...
				array(
					'filename'  => 'my-new-pattern-copied-2',
			...
			array(
				...
				array(
					...
					'my-new-pattern-copied-9' => array(
						'filename'  => 'my-new-pattern-copied-9',
