				...
				<div className="mx-auto max-w-7xl flex justify-between gap-20">
					...
					<div className="flex-1 text-base">
						<div className="bg-fses-gray p-8 gap-6 flex flex-col rounded mb-5">
							<div>
								<h4 className="mb-2 font-medium">Create new patterns</h4>
								<p className="text-base mb-5">Create new patterns for your theme using the button below. Patterns will appear on this page as you create them.</p>
								<button
								...
								>{ __( 'Create A New Pattern', 'fse-studio' ) }</button>
							</div>
						</div>
