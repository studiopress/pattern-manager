...
export default function useThemeJsonFile( id ) {
	...
	function setValue(
		...
		if (
			...
			Array.isArray( modifiedData.content[ topLevelSection ] )
		) {
			modifiedData.content[ topLevelSection ] = {};
		}
		...
		if ( numberOfKeys === 1 ) {
			...
			if ( mode === 'insert' ) {
				modifiedData.content[ topLevelSection ].splice(
					parseInt( keyOne ) + 1,
					0,
					value
				);
		...
		if ( numberOfKeys === 2 ) {
			...
			if ( mode === 'insert' ) {
				modifiedData.content[ topLevelSection ][ keyOne ].splice(
					parseInt( keyTwo ) + 1,
					0,
					value
				);
	...
	function getValue(
		...
		if ( numberOfKeys === 1 ) {
			const keyOne = [ keys[ 0 ] ];
			if (
				themeJsonData.content[ topLevelSection ].hasOwnProperty(
					keyOne
				)
			) {
		...
		if ( numberOfKeys === 2 ) {
			...
			if (
				...
				if (
					themeJsonData.content[ topLevelSection ][
						keyOne
		...
		if ( numberOfKeys === 3 ) {
			...
			if (
				...
				if (
					...
					if (
						themeJsonData.content[ topLevelSection ][ keyOne ][
							keyTwo
						].hasOwnProperty( keyThree )
					) {
						return themeJsonData.content[ topLevelSection ][
							keyOne
						][ keyTwo ][ keyThree ];
					}
				}
