...
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-button"><?php echo esc_html__( 'Image, heading, text, button.', 'fse-studio' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/sample-white_1200x1200.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-242"/></figure>
<!-- /wp:image -->
