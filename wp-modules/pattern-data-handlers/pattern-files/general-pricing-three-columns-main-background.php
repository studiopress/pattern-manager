 ...
 * Slug: frost/general-pricing-three-columns-main-background
...
<p class="has-text-align-center"><?php echo esc_html__( 'Create a three-column table, wide-width', 'fse-studio' ); ?> (1200px).</p>
<!-- /wp:paragraph -->
