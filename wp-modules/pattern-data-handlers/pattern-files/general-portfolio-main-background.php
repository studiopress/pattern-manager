...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/portfolio-white_800x800_1.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-3492"/></figure>
<!-- /wp:image -->
<!-- wp:image {"id":3493,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/portfolio-white_800x800_2.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-3493"/></figure>
<!-- /wp:image -->
<!-- wp:image {"id":3494,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/portfolio-white_800x800_3.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-3494"/></figure>
<!-- /wp:image -->
<!-- wp:image {"id":3495,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/portfolio-white_800x800_4.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-3495"/></figure>
<!-- /wp:image --></figure>
<!-- /wp:gallery -->
</div>
<!-- /wp:column -->
