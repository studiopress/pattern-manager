...
<h2 class="has-x-large-font-size" id="sample-podcast-episode"><?php echo esc_html__( 'Sample Podcast Episode', 'fse-studio' ); ?></h2>
<!-- /wp:heading -->
...
<!-- /wp:paragraph -->
<!-- wp:audio {"id":3546} -->
<figure class="wp-block-audio"><audio controls src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/sample-audio-file.mp3', 'fse-studio' ) ); ?>"></audio></figure>
<!-- /wp:audio -->
