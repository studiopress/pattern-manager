 ...
 * Slug: frost/general-pricing-two-columns-main-background
...
<p class="has-text-align-center"><?php echo esc_html__( 'Create a two-column table, wide-width', 'fse-studio' ); ?> (800px).</p>
<!-- /wp:paragraph -->
