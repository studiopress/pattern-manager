 ...
 * Slug: frost/page-split-text-cover
...
<h2 class="has-x-large-font-size" id="text-on-left-image-on-right"><?php echo esc_html__( 'Text on left, cover on right.', 'fse-studio' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
