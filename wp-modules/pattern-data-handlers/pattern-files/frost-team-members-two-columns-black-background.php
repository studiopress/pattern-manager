...
return array(
	...
	'name'          => 'frost-team-members-two-columns-black-background',
...
<!-- wp:column {"width":"75%"} -->
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:heading {"level":4,"fontSize":"medium"} -->
<h4 class="has-medium-font-size" id="member-name-1">Member Name</h4>
<!-- /wp:heading -->
...
<!-- wp:column {"width":"75%"} -->
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:heading {"level":4,"fontSize":"medium"} -->
<h4 class="has-medium-font-size" id="member-name-2">Member Name</h4>
<!-- /wp:heading -->
