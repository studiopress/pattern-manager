...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/sample-black_1920x1200.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-3480"/></figure>
<!-- /wp:image -->
<!-- wp:spacer {"height":60} -->
...
<div class="wp-block-button"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Get Started', 'fse-studio' ); ?></a></div>
<!-- /wp:button -->
<!-- wp:button {"style":{"border":{"radius":0}},"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Learn More', 'fse-studio' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
...
<figure class="wp-block-media-text__media"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/sample-white_1200x1200-1024x1024.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-3484 size-full"/></figure>
<div class="wp-block-media-text__content"><!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="has-x-large-font-size" id="text-on-left-media-on-right"><?php echo esc_html__( 'Text on left, media on right.', 'fse-studio' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-button is-style-fill-base"><a class="wp-block-button__link"><?php echo esc_html__( 'Get Started', 'fse-studio' ); ?></a></div>
<!-- /wp:button -->
<!-- wp:button {"className":"is-style-outline-base"} -->
<div class="wp-block-button is-style-outline-base"><a class="wp-block-button__link"><?php echo esc_html__( 'Learn More', 'fse-studio' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<figure class="wp-block-media-text__media"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/sample-black_1200x1200-1024x1024.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-3485 size-full"/></figure>
<div class="wp-block-media-text__content">
<!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="has-x-large-font-size" id="text-on-left-media-on-right"><?php echo esc_html__( 'Media on left, text on right.', 'fse-studio' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectetur adipiscing vestibulum. Fringilla nec accumsan eget, facilisis mi justo, luctus pellentesque gravida vitae non diam accumsan posuere, venenatis mi turpis.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link"><?php echo esc_html__( 'Get Started', 'fse-studio' ); ?></a></div>
<!-- /wp:button -->
<!-- wp:button {"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link"><?php echo esc_html__( 'Learn More', 'fse-studio' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<div class="wp-block-button is-style-fill-base"><a class="wp-block-button__link" style="border-radius:0px;padding-top:15px;padding-right:25px;padding-bottom:15px;padding-left:25px"><?php echo esc_html__( 'Let’s Get Started', 'fse-studio' ); ?> →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<!-- /wp:spacer -->
<!-- wp:heading {"textAlign":"center","fontSize":"x-large"} -->
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-button-1"><?php echo esc_html__( 'Image, heading, text, button.', 'fse-studio' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( __( 'https://frostwp.com/wp-content/uploads/2021/12/sample-black_1200x1200.jpg', 'fse-studio' ) ); ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'fse-studio' ); ?>" class="wp-image-676"/></figure>
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3} -->
<h3 class="has-text-align-center" id="sample-heading-1"><?php echo esc_html__( 'Sample Heading', 'fse-studio' ); ?></h3>
<!-- /wp:heading -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3} -->
<h3 class="has-text-align-center" id="sample-heading-2"><?php echo esc_html__( 'Sample Heading', 'fse-studio' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"18px"}}} -->
<p class="has-text-align-center" style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris finibus dolor ex, non hendrerit purus vulputate blandit.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3} -->
<h3 class="has-text-align-center" id="sample-heading-3"><?php echo esc_html__( 'Sample Heading', 'fse-studio' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"18px"}}} -->
<p class="has-text-align-center" style="font-size:18px">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris finibus dolor ex, non hendrerit purus vulputate blandit.</p>
<!-- /wp:paragraph -->
