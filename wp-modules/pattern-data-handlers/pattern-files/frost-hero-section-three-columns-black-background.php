...
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-button">Image, heading, text, button.</h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="https://frostwp.com/wp-content/uploads/2021/12/sample-white_1200x1200.jpg" alt="Sample Image" class="wp-image-242"/></figure>
<!-- /wp:image -->
