...
<h2 class="has-text-align-center has-max-48-font-size" id="let-s-connect" style="font-style:normal;font-weight:400;margin-bottom:20px"><?php echo esc_html__( 'Let’s Connect', 'fse-studio' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline-base"><a class="wp-block-button__link no-border-radius" href="#"><?php echo esc_html__( 'Get in Touch', 'fse-studio' ); ?> →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center has-small-font-size">© <?php echo gmdate( 'Y' ); ?> Your Company LLC · <a href="#"><?php echo esc_html__( 'Contact Us', 'fse-studio' ); ?></a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
